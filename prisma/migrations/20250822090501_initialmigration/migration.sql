-- CreateEnum
CREATE TYPE "public"."ProgramStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'APPROVED', 'VERIFIED', 'RECOMMENDED', 'CONTRACTED', 'MONITORING', 'PAYMENT_RUNNING', 'PAYMENT_FINAL', 'CLOSED', 'ARCHIVED');
...
-- AddForeignKey
ALTER TABLE "public"."Program" ADD CONSTRAINT "Program_wardId_fkey" FOREIGN KEY ("wardId") REFERENCES "public"."Ward"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
